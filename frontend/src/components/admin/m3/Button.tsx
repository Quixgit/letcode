...
const VARIANTS: Record<Variant, string> = {
  filled: "bg-md-primary text-md-on-primary hover:opacity-90 active:opacity-80",
  ...
  outlined: "border border-md-outline-variant text-md-on-surface hover:bg-md-surface-container-high active:bg-md-surface-container-highest",
